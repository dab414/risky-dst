...
def PostHits(pay, lifetime, max_assignments, exp):
	...
	description = 'This HIT will take about 10 mins to complete. All HITS in this batch are the same, and you will only be able to perform one of the HITS in this batch.'
