...
def main():
  ...
  for entry in final_data:
    ...
    if not os.path.exists('/home/dave/OneDrive/Research/By Project/Dissertation/experiments/production/exp1/dataProcessing/csvData/'):
      os.mkdir('/home/dave/OneDrive/Research/By Project/Dissertation/experiments/production/exp1/dataProcessing/csvData/')
    
    df.to_csv('/home/dave/OneDrive/Research/By Project/Dissertation/experiments/production/exp1/dataProcessing/csvData/' + entry + '.csv', index = False)
